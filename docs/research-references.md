...
| 类别 | 特征 | 与 Linna 的差异 |
|------|------|------------|
| 本地知识管理工具 | 双向链接、本地文件存储 | 无 3D 空间组织，AI 能力有限 |
| 全能文档平台 | 结构化文档 + AI 辅助 | 云端存储，AI 不基于个人知识库 |
| AI 记忆层 API | 为 AI 应用提供持久化记忆 | 基础设施层，无用户界面 |
| AI 个人助手 | 持续采集 + 个人记忆 | 被动记录，无主动知识构建 |
| 3D 空间知识框架 | 开源技术框架，知识 3D 化 | 面向开发者，非消费产品 |

Linna 的组合——3D 空间宇宙 + 个人知识库驱动的 AI + 多模型载体平台——在当前已发表的学术文献和产品中**未见同类组合**。
